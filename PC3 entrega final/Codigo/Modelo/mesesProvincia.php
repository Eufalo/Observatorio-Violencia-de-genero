<?php
	...
	require('db.php');
	$sel_query="SELECT MONTH(Fecha_) as mes, COUNT(ID_Noticia) as casos from 	proyecto2.Localizacion where ID_Provincia like ".$id." AND Fecha_ BETWEEN '".$inicio."' 	AND '".$fin."' group by month(Fecha_);";
	//echo $sel_query;
