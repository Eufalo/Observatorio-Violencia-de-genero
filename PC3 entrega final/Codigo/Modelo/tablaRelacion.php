...
<table id="tabla">
	...
	<?php
	require('db.php');
	if(isset($_REQUEST['Parentesco'])){// Introduciendo un id planta.
		$parentesco= $_REQUEST['Parentesco'];
	$count=0;
	$nombre="";
	$sel_query="SELECT Informacion.ID_Noticia, Informacion.RelacionV_A FROM Informacion WHERE  Informacion.RelacionV_A = '". $parentesco."' order by ID_Noticia DESC;";
