<?php
	...
	require('db.php');
	$sel_query="SELECT Year(Fecha_) as ano, COUNT(ID_Noticia) as casos from 	proyecto2.Localizacion where ID_CCAA like ".$id." AND Fecha_ BETWEEN '".$inicio."' 	AND '".$fin."' group by Year(Fecha_);";
	//echo $sel_query;
